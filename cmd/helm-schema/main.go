...
func worker(
	dryRun, keepFullComment, dontRemoveHelmDocsPrefix, omitRequiredProperties bool,
	...
	for chartPath := range queue {
		...
		result.Schema = schema.YamlToSchema(&values, keepFullComment, dontRemoveHelmDocsPrefix, omitRequiredProperties, nil)
...
func exec(cmd *cobra.Command, _ []string) error {
	...
	omitRequiredProperties := viper.GetBool("omit-required-properties")
